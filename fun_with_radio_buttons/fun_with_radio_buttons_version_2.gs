...
function doGet(e){
  ...
  vPanel.add(app.createLabel("Do you like vanilla?"));
  vPanel.add(app.createRadioButton('doYouLikeVanilla','Yes').setFormValue('Yes').setId('doYouLikeVanilla').setName('doYouLikeVanilla'));
  vPanel.add(app.createRadioButton('doYouLikeVanilla','No').setFormValue('No').setId('doYouLikeVanilla').setName('doYouLikeVanilla'));
...
function doPost(e){
  ...
  vPanel.add(app.createLabel("And the answer to whether you like vanilla is: "+e.parameter.doYouLikeVanilla));
